<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorPage.aspx.cs" Inherits="UniversityApp.InstructorPage" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <table class="center">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox
                            class="tb"
                            ID="tb_delete_instructorLastname"
                            runat="server"
                            ReadOnly="true" />            <!--to block input-->
                    </td>    
                    <td> 
        ...
        <div>
            <h3>All Records In The Instructor Table</h3><br />
            <table class="center">
                <tr>
                    <td colspan="4">
                        <asp:GridView 
                            class="gv"
                            ID="gv_allInstructors" 
                            runat="server">
                        </asp:GridView>
                    </td>
                </tr>
